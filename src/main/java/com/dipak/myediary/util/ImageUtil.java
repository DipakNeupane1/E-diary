...
public class ImageUtil {
	public static final String FILE_UPLOAD_PATH = "/C:/Users/Dipak Neupane/Desktop/javapractice/";
	...
	public static void displayFriendImage(int fid, String imageUrl, HttpServletRequest request, HttpServletResponse response) {
		File file = new File(imageUrl);
